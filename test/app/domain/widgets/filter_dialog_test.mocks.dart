...
// in formularios_front/test/app/domain/widgets/filter_dialog_test.dart.
...
class MockFilterFormsController extends _i1.Mock
    implements _i8.FilterFormsController {
  ...
  @override
  set filteredStatus(_i4.FormStatusEnum? _filteredStatus) => super.noSuchMethod(
        Invocation.setter(
          #filteredStatus,
          _filteredStatus,
        ),
  ...
  @override
  void setStatus(_i4.FormStatusEnum? value) => super.noSuchMethod(
        Invocation.method(
          #setStatus,
          [value],
        ),
