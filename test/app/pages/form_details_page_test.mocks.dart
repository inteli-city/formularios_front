...
// in formularios_front/test/app/pages/form_details_page_test.dart.
...
class MockFormDetailsController extends _i1.Mock
    implements _i11.FormDetailsController {
  MockFormDetailsController() {
    _i1.throwOnMissingStub(this);
  }

  @override
  String get externId => (super.noSuchMethod(
        Invocation.getter(#externId),
        returnValue: _i6.dummyValue<String>(
          this,
          Invocation.getter(#externId),
        ),
